...
<div class="category-page">
    <div class="page-header">
        <h1>🔧 Công nghệ</h1>
        <p>Tin tức công nghệ mới nhất, xu hướng và phát triển trong lĩnh vực công nghệ</p>
    </div>
    ...
    <div class="news-grid">
        ...
        <div class="news-item">
            <a href="${pageContext.request.contextPath}/CodeLensNew?tab=news&id=2">
                ...
                <div class="news-content">
                    <h3>🧬 Phát minh y tế thông minh</h3>
                    <p>Công nghệ y tế đang phát triển mạnh mẽ với sự hỗ trợ của AI và machine learning...</p>
                    <div class="news-meta">
                        <span><i class="fas fa-calendar"></i> 14/10/2025</span>
